...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['namespace' => 'SupportTeam',], function(){
        ...
        Route::resource('class_notebooks', 'ClassNotebookController');
    ...
    Route::group(['prefix' => 'ajax'], function() {
        ...
        // Route::get('get_section_class_notebooks/{section_id}', 'AjaxController@get_section_class_notebooks')->name('get_section_class_notebooks');
    });
